...
import { WebSocketHandler } from 'elysia/ws/bun';
import type { Context } from 'elysia/context';
import { AfterResponseHandler, DocumentDecoration, ErrorHandler, InputSchema, MapResponse, MaybeArray, MaybePromise, MetadataBase, OptionalHandler, Prettify, RouteSchema, SingletonBase, TransformHandler } from 'elysia/types';
...
export type WSLocalHook<LocalSchema extends InputSchema, Schema extends RouteSchema, Singleton extends SingletonBase, Macro extends MetadataBase['macro']> = Prettify<Macro> & (LocalSchema extends any ? LocalSchema : Prettify<LocalSchema>) & {
