import type { ServerWebSocket, ServerWebSocketSendStatus, BufferSource, WebSocketHandler } from 'elysia/ws/bun';
import type { TSchema } from '@sinclair/typebox';
import type { TypeCheck } from 'elysia/type-system';
import type { ElysiaTypeCheck } from 'elysia/schema';
import type { FlattenResponse, WSParseHandler } from 'elysia/ws/types';
import type { MaybeArray, Prettify, RouteSchema } from 'elysia/types';
...
export declare class ElysiaWS<Context = unknown, Route extends RouteSchema = {}> implements ElysiaServerWebSocket {
    ...
    get readyState(): import("elysia/ws/bun").WebSocketReadyState;
}
...
export type { WSLocalHook } from 'elysia/ws/types';
